const contentData = [
    {
        ...
        kicker: "Profil",
        title: "Tentang Saya",
        desc: "Lulusan SMK IDNBS Bogor jurusan Software Development dan saat ini menempuh S1 Informatika di Telkom University. Berpengalaman sebagai Fullstack & DevOps Engineer, juga menjadi trainer di beberapa IT Camp. Memiliki semangat belajar tinggi, suka tantangan, dan cepat beradaptasi.",
        exp: "-Fullstack & DevOps Engineer(intern), Yayasan Bina Insan Taqwa\n-SCRATCH Trainer, IDNBS( IDN IT CAMP BATCH 2)\n-MicroBit Trainer, IDNBS( IDN IT CAMP BATCH 2)\n-UI/UX Trainer – Al Ashr Bina Mandiri (2023)\n-3rd Winner of National Coding Competition(AL-HAZEN ACADEMY)",
        skills:"-Frontend: HTML, CSS, JS, PHP, Dart, Kotlin, Mobile/Web, Responsive, Design, UI/UX ,React, Lowcoder\n-Backend & Database: Node.js, NestJS, PHP, Laravel, Python, MySQL, PostgreSQL, Prisma\n-Web3: Solidity, Ethers.js\n-Cloud & DevOps: Linux, Docker, KVM, Networking, Firewall Configuration, CI/CD, Nginx, Apache, Git, GitHub Actions",
